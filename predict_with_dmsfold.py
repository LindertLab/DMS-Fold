...
def main(args):
    ...
    output_name = f'{tag}_model_5_ptm_dms'
    ...
    if not args.skip_relaxation:        
        ...
        relaxed_pdb_str, _, _ = amber_relaxer.process(prot=unrelaxed_protein,cif_output = False)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--preset", type=str, default='reduced_dbs',
