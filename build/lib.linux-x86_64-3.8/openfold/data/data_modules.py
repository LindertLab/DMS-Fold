...
class OpenFoldSingleDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        print(name)
        print(idx)
        print(self.idx_to_chain_id(idx))
        idx_name = str(idx)
        ...
        if(self.mode == 'train' or self.mode == 'eval'):
            ...
            path = os.path.join(self.data_dir, name) #ZD: Changed file_id to name
        ...
        dms = self.dmss[self._chain_id_to_idx_dict[name]]
        data['dms'] = dms
